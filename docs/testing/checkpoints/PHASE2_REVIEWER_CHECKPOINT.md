...
- Active root application only; the historical duplicate copy was outside this QA run's scope.
...
- `docs/testing/checkpoints/PHASE1_QA_CHECKPOINT.md`
- `docs/testing/checkpoints/PHASE2_REVIEWER_CHECKPOINT.md`
