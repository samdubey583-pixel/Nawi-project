...
const checkpointSchema = new Schema({ checkpoint: String, minutes: Number, indication: Number, unit: String, temperature: Number, recordedAt: Date, testerId: Schema.Types.ObjectId, testerNameSnapshot: String }, { _id: false });
const observationSchema = new Schema({ actualLoad: Number, inputActualLoad: Number, unit: String, indication: Number, indicationUnit: String, zeroBefore: Number, zeroAfter: Number, inputZeroAfter: Number, zeroAfterUnit: String, zeroReturnDeviation: Number, allowedLimit: Number, mpeValue: Number, mpeUnit: String, mpeRuleReference: String, mpeRuleSetId: String, mpeRuleVersion: String, sourceClause: String, delta30: Number, delta15_30: Number, delta4h: Number, temperatureVariation: Number, temperatureCondition: String, extendedCriterion: Boolean, earlyTerminationAllowed: Boolean, requiredCheckpoint: String, zeroTrackingOffConfirmed: Boolean, stabilizedBefore: Boolean, stabilizedAfter: Boolean, result: String, recordedAt: Date, testerId: Schema.Types.ObjectId, testerNameSnapshot: String, notes: String }, { _id: false });
