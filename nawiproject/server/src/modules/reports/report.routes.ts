...
import { TestReport } from './report.model.js';
import { Counter } from './counter.model.js';
import { VerificationSession, CHECKLIST_ITEMS, MVP_VERIFICATION_SECTIONS } from './verification-session.model.js';
...
import { generateRecommendedLoadPlan, getMpe, RULE_VERSION } from '../testing/calculations/mpe/mpeRules.js';
import { evaluateCompliance } from '../testing/calculations/common/compliance.js';
import { generateApplicability, instrumentProfileFromRecord } from '../testing/engine/testApplicability.js';
import { convertMass, isMassUnit, type MassUnit } from '../testing/calculations/common/mass.js';
import { Instrument } from '../instruments/instrument.model.js';
import { calculateChangeoverError, calculateZeroError } from '../testing/calculations/changeover/weighingCalculations.js';
...
import { sourceFingerprint, sourcePhaseFromTest, sourcePhaseIsComplete } from '../testing/a4/a4-3-setting-to-zero/zeroSettingBeforeLoading.js';
import { TareTest } from '../testing/a4/a4-6-tare/TareTest.model.js';
import { calculateNetLoad, generateTareLoadPlan, tareSettingAccuracyResult } from '../testing/calculations/tare/tareCalculations.js';
import { validateScaleIntervals } from '../testing/calculations/common/scaleInterval.js';
...
import { deriveMultipleIndicatingComparisons, MULTIPLE_INDICATING_RULE_REFERENCE, MULTIPLE_INDICATING_SOURCE, MULTIPLE_INDICATING_TEST_VERSION, sourceFingerprint as multipleIndicatingSourceFingerprint } from '../testing/a4/a4-5-multiple-indicating-devices/multipleIndicatingDevices.js';
import { calculationForPosition, eccentricityFingerprint, eccentricityPositions, ECCENTRICITY_SOURCE, ECCENTRICITY_TEST_VERSION } from '../testing/a4/a4-7-eccentricity/eccentricity.js';
import { discriminationFingerprint, discriminationStages, evaluateDiscriminationObservation, DISCRIMINATION_RULE_REFERENCE, DISCRIMINATION_SOURCE, DISCRIMINATION_TEST_VERSION } from '../testing/a4/a4-8-discrimination/discrimination.js';
...
import { evaluateSensitivityObservation, requiredExtraLoad, requiredPermanentDisplacement, sensitivityFingerprint, sensitivityStages, SENSITIVITY_DISPLACEMENT_RULE, SENSITIVITY_MPE_RULE, SENSITIVITY_SOURCE, SENSITIVITY_TEST_VERSION } from '../testing/a4/a4-9-sensitivity/sensitivity.js';
import { RepeatabilityTest } from '../testing/a4/a4-10-repeatability/RepeatabilityTest.model.js';
import { calculateRepeatabilityObservation, evaluateRepeatabilityResults, getRepeatabilityPlan, repeatabilityFingerprint, REPEATABILITY_RULE_REFERENCE, REPEATABILITY_SOURCE, REPEATABILITY_TEST_VERSION, type RepeatabilityControlStage } from '../testing/a4/a4-10-repeatability/repeatability.js';
...
import { calculateVariationMpe, evaluateCreep, evaluateZeroReturn, variationWithTimeFingerprint, variationWithTimePlan, VARIATION_WITH_TIME_ENGINE_VERSION, VARIATION_WITH_TIME_SOURCE, VARIATION_WITH_TIME_TEST_VERSION, type VariationWithTimeCheckpoint } from '../testing/a4/a4-11-variation-with-time/variationWithTime.js';
import { evaluateDocumentationReview, evaluateInhibition, evaluateStabilitySequence, stabilityFingerprint, stabilityPlan, STABILITY_ENGINE_VERSION, STABILITY_REPETITIONS, STABILITY_RULE_SET, STABILITY_SOURCE, STABILITY_TEST_VERSION, normalizeMass, type StabilityOperation } from '../testing/a4/a4-12-stability-of-equilibrium/stabilityOfEquilibrium.js';
import { testerReportAccessFilter, hasTesterReportAccess } from './reportAccess.js';
import { InfluenceFactorsTest } from '../testing/a5/a5-4-voltage/InfluenceFactorsTest.model.js';
import { evaluateInfluenceFactors, influenceFactorsFingerprint, influenceFactorsPlan, calculateInfluenceFactorsError, evaluateInfluenceFactorsCompliance, INFLUENCE_FACTORS_ENGINE_VERSION, INFLUENCE_FACTORS_RULE_SET, INFLUENCE_FACTORS_SOURCE, INFLUENCE_FACTORS_TEST_VERSION } from '../testing/a5/a5-4-voltage/influenceFactors.js';
import { EnduranceTest } from '../testing/a6/a6-endurance/EnduranceTest.model.js';
import { assessDurability, calculateEnduranceWeighing, enduranceApplicability, enduranceFingerprint, endurancePlan, ENDURANCE_CHECKPOINTS, ENDURANCE_ENGINE_VERSION, ENDURANCE_RULE_SET, ENDURANCE_SOURCE, ENDURANCE_TARGET_CYCLES, ENDURANCE_TEST_VERSION, nextCycleCount } from '../testing/a6/a6-endurance/endurance.js';
import { applicationMetadataValidationMessage, canEditReportMetadata, normalizeIndianPhone } from './reportMetadata.js';
import { deriveZeroIndicatorIncrement, validateSignedZeroRanges, validateZeroIndicatorObservations, type ZeroIndicatorObservationInput } from '../testing/a4/a4-2-zero-checking/zeroIndicatorObservations.js';
...
const savePoint = async (test: any, body: any, sequence: number, user: any) => {
  ...
  const point = { sequence, direction, recommendedLoad, unit, inputLoadL, inputIndicationI, inputDeltaL, loadL, indicationI, deltaL, indicatingDevices, ...calculated, updatedAt: new Date() };
