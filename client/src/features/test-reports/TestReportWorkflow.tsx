...
type Form = {
  ...
  manufacturer: string; model: string; serial: string; accuracyClass: string; indication: string; unit: string; min: string; max: string; e: string; d: string; software: string; softwareVersion?: string; loadCell: string; interfaces: string[]; notes: string;
